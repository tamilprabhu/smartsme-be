...
router.get('/:id', authenticate, async (req, res) => {
    ...
    try {
        ...
        logger.info(`GET /users/${id} - Successfully retrieved user`, {
            requestId,
            username,
            userId: id,
        });
...
router.post('/', authenticate, async (req, res, next) => {
    ...
    try {
        ...
        logger.info(`POST /users - Successfully created user`, {
            requestId,
            username,
            newUserId: user.id,
        });
...
router.put('/:id', authenticate, async (req, res, next) => {
    ...
    try {
        ...
        if (!user) {
            logger.warn(`PUT /users/${id} - User not found for update`, {
                requestId,
                username,
                userId: id,
            });
...
router.delete('/:id', authenticate, async (req, res) => {
    ...
    try {
        ...
        if (!deleted) {
            logger.warn(`DELETE /users/${id} - User not found for deletion`, {
                requestId,
                username,
                userId: id,
            });
