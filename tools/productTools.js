...
const searchProductsTool = tool(
    async ({
        ...
        try {
            ...
            const selectedFields = normalizedFields.map((field) => fieldMap[field]).filter(Boolean);
    ...
    },
    {
        ...
        description:
            'Search and list products from the company catalog. Supports limiting results and selecting output fields like name or productId.',
        schema: z.object({
            ...
            limit: z
                ...
                .nullable()
                .optional()
                .describe('Maximum number of products to return, string for example "5"'),
            fields: z
                .string()
                .nullable()
                .optional()
                .describe(
                    'Comma-separated fields to include in the output, for example: name,productId',
                ),
        }),
    },
);
