...
CREATE TABLE `mst_company` (
  ...
  `direct_phone` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `office_phone` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mgmt_phone` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `txn_stock` (
  ...
  `inward_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
