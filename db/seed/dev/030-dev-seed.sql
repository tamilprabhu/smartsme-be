...
(1004, 'PRES_PR_002', 'PRES001', 'Cooker Handle', 'A380', 12.0000, 15, 1.8000, 13.8000, 6, 2.50, 0.25, 120, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1005, 'FINO_PR_003', 'FINO001', 'PVC Pipe 6 inch', 'PVC-Resin', 3.8000, 5, 0.190, 3.990, 6, 1.50, 0.15, 180, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1006, 'FINO_PR_004', 'FINO001', 'PVC T-Joint', 'PVC-Compound', 1.2000, 7, 0.084, 1.284, 10, 0.90, 0.09, 250, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1007, 'FINO_PR_005', 'FINO001', 'PVC Reducer', 'PVC-Resin', 1.5000, 6, 0.090, 1.590, 8, 1.00, 0.10, 220, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1008, 'FINO_PR_006', 'FINO001', 'PVC End Cap', 'PVC-Compound', 0.6000, 8, 0.048, 0.648, 15, 0.70, 0.07, 320, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1009, 'FINO_PR_007', 'FINO001', 'PVC Coupling', 'PVC-Resin', 0.9000, 7, 0.063, 0.963, 12, 0.85, 0.085, 280, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1010, 'FINO_PR_008', 'FINO001', 'PVC Valve', 'PVC-Compound', 2.2000, 9, 0.198, 2.398, 5, 1.30, 0.13, 160, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1011, 'PRES_PR_003', 'PRES001', 'Pressure Cooker Lid', 'ADC-12', 28.0000, 10, 2.800, 30.800, 1, 7.50, 0.75, 70, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1012, 'PRES_PR_004', 'PRES001', 'Safety Valve', 'A380', 8.5000, 12, 1.020, 9.520, 8, 2.20, 0.22, 140, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1013, 'PRES_PR_005', 'PRES001', 'Gasket Ring', 'Silicone', 0.3000, 15, 0.045, 0.345, 20, 0.50, 0.05, 400, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1014, 'PRES_PR_006', 'PRES001', 'Pressure Indicator', 'Brass', 5.2000, 8, 0.416, 5.616, 6, 1.80, 0.18, 150, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1015, 'PRES_PR_007', 'PRES001', 'Handle Grip', 'Bakelite', 3.8000, 10, 0.380, 4.180, 10, 1.60, 0.16, 180, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1016, 'FINO_PR_009', 'FINO001', 'PVC Pipe 2 inch', 'PVC-Resin', 1.8000, 5, 0.090, 1.890, 10, 1.10, 0.11, 240, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1017, 'FINO_PR_010', 'FINO001', 'PVC Cross Joint', 'PVC-Compound', 1.6000, 7, 0.112, 1.712, 8, 1.05, 0.105, 200, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1018, 'FINO_PR_011', 'FINO001', 'PVC Ball Valve', 'PVC-Resin', 3.2000, 8, 0.256, 3.456, 4, 1.70, 0.17, 140, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1019, 'FINO_PR_012', 'FINO001', 'PVC Union', 'PVC-Compound', 1.4000, 6, 0.084, 1.484, 9, 0.95, 0.095, 260, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1020, 'FINO_PR_013', 'FINO001', 'PVC Flange', 'PVC-Resin', 2.8000, 7, 0.196, 2.996, 6, 1.40, 0.14, 170, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1021, 'PRES_PR_008', 'PRES001', 'Cooker Base Plate', 'Aluminum', 15.5000, 11, 1.705, 17.205, 2, 4.50, 0.45, 90, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1022, 'PRES_PR_009', 'PRES001', 'Steam Vent', 'Stainless Steel', 2.8000, 9, 0.252, 3.052, 12, 1.45, 0.145, 200, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1023, 'PRES_PR_010', 'PRES001', 'Locking Mechanism', 'Steel', 6.8000, 13, 0.884, 7.684, 4, 2.80, 0.28, 110, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1024, 'PRES_PR_011', 'PRES001', 'Heat Distributor', 'Copper', 4.2000, 8, 0.336, 4.536, 8, 1.90, 0.19, 160, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1025, 'PRES_PR_012', 'PRES001', 'Whistle Assembly', 'Brass', 1.8000, 12, 0.216, 2.016, 15, 1.20, 0.12, 250, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1026, 'FINO_PR_014', 'FINO001', 'PVC Pipe 8 inch', 'PVC-Resin', 5.2000, 6, 0.312, 5.512, 4, 2.10, 0.21, 120, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1027, 'FINO_PR_015', 'FINO001', 'PVC Bend 45°', 'PVC-Compound', 1.8000, 8, 0.144, 1.944, 8, 1.15, 0.115, 210, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1028, 'FINO_PR_016', 'FINO001', 'PVC Bend 90°', 'PVC-Compound', 2.1000, 8, 0.168, 2.268, 7, 1.25, 0.125, 190, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1029, 'FINO_PR_017', 'FINO001', 'PVC Adapter', 'PVC-Resin', 1.1000, 7, 0.077, 1.177, 11, 0.88, 0.088, 270, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1030, 'FINO_PR_018', 'FINO001', 'PVC Plug', 'PVC-Compound', 0.4000, 9, 0.036, 0.436, 18, 0.60, 0.06, 350, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1031, 'PRES_PR_013', 'PRES001', 'Cooker Inner Pot', 'Stainless Steel', 22.0000, 9, 1.980, 23.980, 1, 6.20, 0.62, 80, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1032, 'PRES_PR_014', 'PRES001', 'Rubber Seal', 'Rubber', 0.8000, 15, 0.120, 0.920, 25, 0.75, 0.075, 300, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1033, 'PRES_PR_015', 'PRES001', 'Pressure Release Valve', 'Brass', 3.5000, 10, 0.350, 3.850, 10, 1.75, 0.175, 170, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1034, 'PRES_PR_016', 'PRES001', 'Handle Screw', 'Steel', 0.2000, 8, 0.016, 0.216, 50, 0.40, 0.04, 500, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1035, 'PRES_PR_017', 'PRES001', 'Base Ring', 'Aluminum', 8.8000, 11, 0.968, 9.768, 3, 3.20, 0.32, 100, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1036, 'FINO_PR_019', 'FINO001', 'PVC Pipe 10 inch', 'PVC-Resin', 6.8000, 6, 0.408, 7.208, 3, 2.50, 0.25, 100, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1037, 'FINO_PR_020', 'FINO001', 'PVC Tee Reducer', 'PVC-Compound', 2.4000, 7, 0.168, 2.568, 6, 1.35, 0.135, 180, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1038, 'FINO_PR_021', 'FINO001', 'PVC Check Valve', 'PVC-Resin', 4.2000, 9, 0.378, 4.578, 3, 1.95, 0.195, 130, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1039, 'FINO_PR_022', 'FINO001', 'PVC Bushing', 'PVC-Compound', 0.7000, 8, 0.056, 0.756, 14, 0.78, 0.078, 290, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1040, 'FINO_PR_023', 'FINO001', 'PVC Nipple', 'PVC-Resin', 0.5000, 7, 0.035, 0.535, 16, 0.65, 0.065, 330, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1041, 'PRES_PR_018', 'PRES001', 'Cooker Trivet', 'Steel', 4.5000, 10, 0.450, 4.950, 8, 2.00, 0.20, 150, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1042, 'PRES_PR_019', 'PRES001', 'Lid Handle', 'Bakelite', 2.2000, 12, 0.264, 2.464, 12, 1.30, 0.13, 220, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1043, 'PRES_PR_020', 'PRES001', 'Safety Lock', 'Steel', 5.8000, 11, 0.638, 6.438, 5, 2.40, 0.24, 120, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1044, 'PRES_PR_021', 'PRES001', 'Vent Tube', 'Aluminum', 1.5000, 9, 0.135, 1.635, 18, 1.05, 0.105, 280, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1045, 'PRES_PR_022', 'PRES001', 'Bottom Plate', 'Stainless Steel', 18.2000, 8, 1.456, 19.656, 2, 5.50, 0.55, 85, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1046, 'FINO_PR_024', 'FINO001', 'PVC Pipe 12 inch', 'PVC-Resin', 8.5000, 6, 0.510, 9.010, 2, 3.00, 0.30, 80, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1047, 'FINO_PR_025', 'FINO001', 'PVC Wye Joint', 'PVC-Compound', 2.8000, 8, 0.224, 3.024, 5, 1.50, 0.15, 160, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1048, 'FINO_PR_026', 'FINO001', 'PVC Gate Valve', 'PVC-Resin', 5.5000, 9, 0.495, 5.995, 2, 2.30, 0.23, 110, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1049, 'FINO_PR_027', 'FINO001', 'PVC Elbow 45°', 'PVC-Compound', 1.3000, 7, 0.091, 1.391, 9, 0.92, 0.092, 250, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1050, 'FINO_PR_028', 'FINO001', 'PVC Socket', 'PVC-Resin', 0.8000, 8, 0.064, 0.864, 13, 0.80, 0.08, 300, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1051, 'PRES_PR_023', 'PRES001', 'Pressure Gauge', 'Brass', 6.2000, 10, 0.620, 6.820, 4, 2.60, 0.26, 115, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1052, 'PRES_PR_024', 'PRES001', 'Steam Pipe', 'Steel', 3.8000, 9, 0.342, 4.142, 9, 1.80, 0.18, 190, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1053, 'PRES_PR_025', 'PRES001', 'Lid Gasket', 'Silicone', 0.6000, 15, 0.090, 0.690, 22, 0.68, 0.068, 320, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1054, 'PRES_PR_026', 'PRES001', 'Handle Base', 'Aluminum', 4.8000, 11, 0.528, 5.328, 7, 2.10, 0.21, 140, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1055, 'PRES_PR_027', 'PRES001', 'Cooker Feet', 'Rubber', 1.2000, 12, 0.144, 1.344, 16, 0.95, 0.095, 260, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1056, 'FINO_PR_029', 'FINO001', 'PVC Pipe 1 inch', 'PVC-Resin', 1.2000, 5, 0.060, 1.260, 12, 0.85, 0.085, 280, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1057, 'FINO_PR_030', 'FINO001', 'PVC Street Elbow', 'PVC-Compound', 1.0000, 8, 0.080, 1.080, 11, 0.82, 0.082, 290, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1058, 'FINO_PR_031', 'FINO001', 'PVC Threaded Cap', 'PVC-Resin', 0.3000, 9, 0.027, 0.327, 20, 0.55, 0.055, 360, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1059, 'FINO_PR_032', 'FINO001', 'PVC Compression Fitting', 'PVC-Compound', 1.8000, 7, 0.126, 1.926, 8, 1.12, 0.112, 220, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1060, 'FINO_PR_033', 'FINO001', 'PVC Expansion Joint', 'PVC-Resin', 3.5000, 8, 0.280, 3.780, 4, 1.80, 0.18, 140, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1061, 'PRES_PR_028', 'PRES001', 'Cooker Rim', 'Stainless Steel', 12.5000, 9, 1.125, 13.625, 3, 4.20, 0.42, 95, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1062, 'PRES_PR_029', 'PRES001', 'Weight Valve', 'Brass', 2.8000, 11, 0.308, 3.108, 11, 1.45, 0.145, 210, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1063, 'PRES_PR_030', 'PRES001', 'Cooker Stand', 'Steel', 8.2000, 10, 0.820, 9.020, 4, 3.10, 0.31, 105, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1064, 'PRES_PR_031', 'PRES001', 'Heat Shield', 'Aluminum', 3.2000, 8, 0.256, 3.456, 10, 1.70, 0.17, 180, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1065, 'PRES_PR_032', 'PRES001', 'Vent Cap', 'Plastic', 0.4000, 12, 0.048, 0.448, 30, 0.58, 0.058, 380, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1066, 'FINO_PR_034', 'FINO001', 'PVC Pipe 3 inch', 'PVC-Resin', 2.2000, 5, 0.110, 2.310, 9, 1.25, 0.125, 200, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1067, 'FINO_PR_035', 'FINO001', 'PVC Saddle Tee', 'PVC-Compound', 2.0000, 7, 0.140, 2.140, 7, 1.20, 0.12, 210, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1068, 'FINO_PR_036', 'FINO001', 'PVC Butterfly Valve', 'PVC-Resin', 6.8000, 9, 0.612, 7.412, 2, 2.80, 0.28, 90, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1069, 'FINO_PR_037', 'FINO001', 'PVC Pipe Clamp', 'PVC-Compound', 0.9000, 8, 0.072, 0.972, 12, 0.85, 0.085, 280, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1070, 'FINO_PR_038', 'FINO001', 'PVC Drain Fitting', 'PVC-Resin', 1.6000, 7, 0.112, 1.712, 8, 1.05, 0.105, 240, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1071, 'PRES_PR_033', 'PRES001', 'Cooker Divider', 'Steel', 5.5000, 10, 0.550, 6.050, 6, 2.30, 0.23, 130, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1072, 'PRES_PR_034', 'PRES001', 'Steam Regulator', 'Brass', 4.2000, 11, 0.462, 4.662, 8, 2.00, 0.20, 160, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1073, 'PRES_PR_035', 'PRES001', 'Cooker Basket', 'Stainless Steel', 7.8000, 9, 0.702, 8.502, 5, 2.90, 0.29, 110, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1074, 'PRES_PR_036', 'PRES001', 'Safety Pin', 'Steel', 0.8000, 8, 0.064, 0.864, 25, 0.75, 0.075, 320, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1075, 'PRES_PR_037', 'PRES001', 'Lid Lock', 'Aluminum', 2.5000, 10, 0.250, 2.750, 12, 1.40, 0.14, 200, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1076, 'FINO_PR_039', 'FINO001', 'PVC Pipe 5 inch', 'PVC-Resin', 4.2000, 6, 0.252, 4.452, 5, 1.90, 0.19, 150, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1077, 'FINO_PR_040', 'FINO001', 'PVC Concentric Reducer', 'PVC-Compound', 1.7000, 7, 0.119, 1.819, 8, 1.08, 0.108, 230, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1078, 'FINO_PR_041', 'FINO001', 'PVC Eccentric Reducer', 'PVC-Compound', 1.9000, 7, 0.133, 2.033, 7, 1.15, 0.115, 220, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1079, 'FINO_PR_042', 'FINO001', 'PVC Pipe Support', 'PVC-Resin', 1.1000, 8, 0.088, 1.188, 10, 0.90, 0.09, 270, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1080, 'FINO_PR_043', 'FINO001', 'PVC Vent Fitting', 'PVC-Compound', 0.6000, 9, 0.054, 0.654, 15, 0.70, 0.07, 340, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1081, 'PRES_PR_038', 'PRES001', 'Cooker Liner', 'Aluminum', 9.5000, 9, 0.855, 10.355, 4, 3.50, 0.35, 100, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1082, 'PRES_PR_039', 'PRES001', 'Pressure Switch', 'Plastic', 1.8000, 12, 0.216, 2.016, 15, 1.20, 0.12, 250, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1083, 'PRES_PR_040', 'PRES001', 'Cooker Tray', 'Steel', 6.2000, 10, 0.620, 6.820, 5, 2.60, 0.26, 120, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1084, 'PRES_PR_041', 'PRES001', 'Handle Spring', 'Steel', 0.3000, 8, 0.024, 0.324, 40, 0.52, 0.052, 450, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1085, 'PRES_PR_042', 'PRES001', 'Cooker Valve Seat', 'Brass', 1.5000, 11, 0.165, 1.665, 18, 1.05, 0.105, 280, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1086, 'FINO_PR_044', 'FINO001', 'PVC Pipe 7 inch', 'PVC-Resin', 5.8000, 6, 0.348, 6.148, 4, 2.40, 0.24, 125, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1087, 'FINO_PR_045', 'FINO001', 'PVC Flexible Coupling', 'PVC-Compound', 2.5000, 8, 0.200, 2.700, 6, 1.40, 0.14, 170, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1088, 'FINO_PR_046', 'FINO001', 'PVC Strainer', 'PVC-Resin', 3.8000, 9, 0.342, 4.142, 3, 1.85, 0.185, 135, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1089, 'FINO_PR_047', 'FINO001', 'PVC Pipe Hanger', 'PVC-Compound', 0.8000, 7, 0.056, 0.856, 13, 0.78, 0.078, 310, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1090, 'FINO_PR_048', 'FINO001', 'PVC Test Cap', 'PVC-Resin', 0.4000, 8, 0.032, 0.432, 18, 0.60, 0.06, 350, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1091, 'PRES_PR_043', 'PRES001', 'Cooker Insulation', 'Fiberglass', 2.2000, 15, 0.330, 2.530, 14, 1.30, 0.13, 230, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1092, 'PRES_PR_044', 'PRES001', 'Steam Collector', 'Steel', 4.8000, 9, 0.432, 5.232, 7, 2.10, 0.21, 145, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1093, 'PRES_PR_045', 'PRES001', 'Cooker Thermometer', 'Glass', 1.2000, 20, 0.240, 1.440, 20, 0.95, 0.095, 300, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1094, 'PRES_PR_046', 'PRES001', 'Handle Washer', 'Rubber', 0.1000, 10, 0.010, 0.110, 60, 0.35, 0.035, 600, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1),
(1095, 'PRES_PR_047', 'PRES001', 'Cooker Timer', 'Plastic', 3.5000, 12, 0.420, 3.920, 9, 1.75, 0.175, 180, 'Sales', 'HSN', 18.00, NOW(), NOW(), 0, 1);
...
(1004,	'PRES_OR_002',	'PRES001',	'PRES_SH_002',	'PRES_PR_002',	'PRES_DC_001',	'2025-01-28 06:00:00',	'2025-01-28 14:00:00',	'1',	'1',	'8',	1000014,	1000016,	NULL,	1000013,	0,	400,	400,	25,	375,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1005,	'FINO_OR_003',	'FINO001',	'FINO_SH_003',	'FINO_PR_003',	'FINO_DC_002',	'2025-02-08 06:00:00',	'2025-02-08 14:00:00',	'1',	'1',	'8',	1000017,	1000018,	NULL,	1000002,	0,	320,	320,	12,	308,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1006,	'FINO_OR_004',	'FINO001',	'FINO_SH_004',	'FINO_PR_004',	'FINO_DC_003',	'2025-02-10 06:00:00',	'2025-02-10 14:00:00',	'1',	'1',	'8',	1000019,	1000020,	NULL,	1000003,	0,	600,	600,	25,	575,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1007,	'FINO_OR_005',	'FINO001',	'FINO_SH_005',	'FINO_PR_005',	'FINO_TR_002',	'2025-02-12 06:00:00',	'2025-02-12 14:00:00',	'1',	'1',	'8',	1000021,	1000022,	NULL,	1000004,	0,	480,	480,	18,	462,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1008,	'FINO_OR_006',	'FINO001',	'FINO_SH_006',	'FINO_PR_006',	'FINO_TR_003',	'2025-02-14 06:00:00',	'2025-02-14 14:00:00',	'1',	'1',	'8',	1000023,	1000024,	NULL,	1000005,	0,	800,	800,	30,	770,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1009,	'FINO_OR_007',	'FINO001',	'FINO_SH_007',	'FINO_PR_007',	'FINO_DM_002',	'2025-02-16 06:00:00',	'2025-02-16 14:00:00',	'1',	'1',	'8',	1000025,	1000026,	NULL,	1000006,	0,	720,	720,	22,	698,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1010,	'FINO_OR_008',	'FINO001',	'FINO_SH_008',	'FINO_PR_008',	'FINO_DM_003',	'2025-02-18 06:00:00',	'2025-02-18 14:00:00',	'1',	'1',	'8',	1000027,	1000028,	NULL,	1000007,	0,	240,	240,	15,	225,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1011,	'FINO_OR_009',	'FINO001',	'FINO_SH_009',	'FINO_PR_009',	'FINO_TM_002',	'2025-02-20 06:00:00',	'2025-02-20 14:00:00',	'1',	'1',	'8',	1000005,	1000006,	NULL,	1000008,	0,	560,	560,	20,	540,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1012,	'FINO_OR_010',	'FINO001',	'FINO_SH_010',	'FINO_PR_010',	'FINO_TM_003',	'2025-02-22 06:00:00',	'2025-02-22 14:00:00',	'1',	'1',	'8',	1000007,	1000008,	NULL,	1000009,	0,	400,	400,	16,	384,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1013,	'FINO_OR_011',	'FINO001',	'FINO_SH_011',	'FINO_PR_011',	'FINO_CNC_002',	'2025-02-24 06:00:00',	'2025-02-24 14:00:00',	'1',	'1',	'8',	1000009,	1000010,	NULL,	1000010,	0,	160,	160,	8,	152,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1014,	'FINO_OR_012',	'FINO001',	'FINO_SH_012',	'FINO_PR_012',	'FINO_CNC_003',	'2025-02-26 06:00:00',	'2025-02-26 14:00:00',	'1',	'1',	'8',	1000011,	1000012,	NULL,	1000011,	0,	640,	640,	24,	616,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1015,	'FINO_OR_013',	'FINO001',	'FINO_SH_013',	'FINO_PR_013',	'FINO_SB_002',	'2025-02-28 06:00:00',	'2025-02-28 14:00:00',	'1',	'1',	'8',	1000013,	1000014,	NULL,	1000012,	0,	320,	320,	12,	308,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1016,	'FINO_OR_014',	'FINO001',	'FINO_SH_014',	'FINO_PR_014',	'FINO_SB_003',	'2025-03-02 06:00:00',	'2025-03-02 14:00:00',	'1',	'1',	'8',	1000015,	1000016,	NULL,	1000013,	0,	120,	120,	6,	114,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1017,	'FINO_OR_015',	'FINO001',	'FINO_SH_015',	'FINO_PR_015',	'FINO_PC_002',	'2025-03-04 06:00:00',	'2025-03-04 14:00:00',	'1',	'1',	'8',	1000017,	1000018,	NULL,	1000014,	0,	480,	480,	18,	462,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1018,	'FINO_OR_016',	'FINO001',	'FINO_SH_016',	'FINO_PR_016',	'FINO_PC_003',	'2025-03-06 06:00:00',	'2025-03-06 14:00:00',	'1',	'1',	'8',	1000019,	1000020,	NULL,	1000015,	0,	400,	400,	15,	385,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1019,	'FINO_OR_017',	'FINO001',	'FINO_SH_017',	'FINO_PR_017',	'FINO_DC_001',	'2025-03-08 06:00:00',	'2025-03-08 14:00:00',	'1',	'1',	'8',	1000021,	1000022,	NULL,	1000016,	0,	720,	720,	28,	692,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1020,	'FINO_OR_018',	'FINO001',	'FINO_SH_018',	'FINO_PR_018',	'FINO_TR_001',	'2025-03-10 06:00:00',	'2025-03-10 14:00:00',	'1',	'1',	'8',	1000023,	1000024,	NULL,	1000017,	0,	1000,	1000,	40,	960,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1021,	'PRES_OR_003',	'PRES001',	'PRES_SH_003',	'PRES_PR_003',	'PRES_DC_002',	'2025-02-08 06:00:00',	'2025-02-08 14:00:00',	'1',	'1',	'8',	1000029,	1000030,	NULL,	1000013,	0,	60,	60,	3,	57,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1022,	'PRES_OR_004',	'PRES001',	'PRES_SH_004',	'PRES_PR_004',	'PRES_DC_003',	'2025-02-10 06:00:00',	'2025-02-10 14:00:00',	'1',	'1',	'8',	1000031,	1000032,	NULL,	1000014,	0,	240,	240,	12,	228,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1023,	'PRES_OR_005',	'PRES001',	'PRES_SH_005',	'PRES_PR_005',	'PRES_TR_002',	'2025-02-12 06:00:00',	'2025-02-12 14:00:00',	'1',	'1',	'8',	1000033,	1000034,	NULL,	1000015,	0,	800,	800,	35,	765,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1024,	'PRES_OR_006',	'PRES001',	'PRES_SH_006',	'PRES_PR_006',	'PRES_TR_003',	'2025-02-14 06:00:00',	'2025-02-14 14:00:00',	'1',	'1',	'8',	1000035,	1000036,	NULL,	1000016,	0,	160,	160,	8,	152,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1025,	'PRES_OR_007',	'PRES001',	'PRES_SH_007',	'PRES_PR_007',	'PRES_DM_002',	'2025-02-16 06:00:00',	'2025-02-16 14:00:00',	'1',	'1',	'8',	1000037,	1000014,	NULL,	1000017,	0,	320,	320,	15,	305,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1026,	'PRES_OR_008',	'PRES001',	'PRES_SH_008',	'PRES_PR_008',	'PRES_DM_003',	'2025-02-18 06:00:00',	'2025-02-18 14:00:00',	'1',	'1',	'8',	1000015,	1000016,	NULL,	1000018,	0,	48,	48,	2,	46,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1027,	'PRES_OR_009',	'PRES001',	'PRES_SH_009',	'PRES_PR_009',	'PRES_TM_002',	'2025-02-20 06:00:00',	'2025-02-20 14:00:00',	'1',	'1',	'8',	1000017,	1000018,	NULL,	1000019,	0,	200,	200,	10,	190,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1028,	'PRES_OR_010',	'PRES001',	'PRES_SH_010',	'PRES_PR_010',	'PRES_TM_003',	'2025-02-22 06:00:00',	'2025-02-22 14:00:00',	'1',	'1',	'8',	1000019,	1000020,	NULL,	1000020,	0,	120,	120,	6,	114,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1029,	'PRES_OR_011',	'PRES001',	'PRES_SH_011',	'PRES_PR_011',	'PRES_CNC_002',	'2025-02-24 06:00:00',	'2025-02-24 14:00:00',	'1',	'1',	'8',	1000021,	1000022,	NULL,	1000021,	0,	240,	240,	12,	228,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1030,	'PRES_OR_012',	'PRES001',	'PRES_SH_012',	'PRES_PR_012',	'PRES_SB_001',	'2025-02-26 06:00:00',	'2025-02-26 14:00:00',	'1',	'1',	'8',	1000023,	1000024,	NULL,	1000022,	0,	400,	400,	18,	382,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1031,	'PRES_OR_013',	'PRES001',	'PRES_SH_013',	'PRES_PR_013',	'PRES_PC_001',	'2025-02-28 06:00:00',	'2025-02-28 14:00:00',	'1',	'1',	'8',	1000025,	1000026,	NULL,	1000023,	0,	32,	32,	2,	30,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1032,	'PRES_OR_014',	'PRES001',	'PRES_SH_014',	'PRES_PR_014',	'PRES_DC_001',	'2025-03-02 06:00:00',	'2025-03-02 14:00:00',	'1',	'1',	'8',	1000027,	1000028,	NULL,	1000024,	0,	600,	600,	25,	575,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1033,	'PRES_OR_015',	'PRES001',	'PRES_SH_015',	'PRES_PR_015',	'PRES_TR_001',	'2025-03-04 06:00:00',	'2025-03-04 14:00:00',	'1',	'1',	'8',	1000029,	1000030,	NULL,	1000025,	0,	160,	160,	8,	152,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1034,	'PRES_OR_016',	'PRES001',	'PRES_SH_016',	'PRES_PR_016',	'PRES_DM_001',	'2025-03-06 06:00:00',	'2025-03-06 14:00:00',	'1',	'1',	'8',	1000031,	1000032,	NULL,	1000026,	0,	1200,	1200,	50,	1150,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1035,	'PRES_OR_017',	'PRES001',	'PRES_SH_017',	'PRES_PR_017',	'PRES_TM_001',	'2025-03-08 06:00:00',	'2025-03-08 14:00:00',	'1',	'1',	'8',	1000033,	1000034,	NULL,	1000027,	0,	80,	80,	4,	76,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1036,	'PRES_OR_018',	'PRES001',	'PRES_SH_018',	'PRES_PR_018',	'PRES_CNC_001',	'2025-03-10 06:00:00',	'2025-03-10 14:00:00',	'1',	'1',	'8',	1000035,	1000036,	NULL,	1000028,	0,	140,	140,	7,	133,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1),
(1037,	'PRES_OR_019',	'PRES001',	'PRES_SH_019',	'PRES_PR_019',	'PRES_SB_001',	'2025-03-12 06:00:00',	'2025-03-12 14:00:00',	'1',	'1',	'8',	1000037,	1000012,	NULL,	1000029,	0,	320,	320,	15,	305,	'Y',	'',	'2026-02-08 12:49:45',	'2026-02-08 12:50:08',	NULL,	NULL,	0,	1);
-- --------------------------------------------------------
