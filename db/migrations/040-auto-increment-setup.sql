...
ALTER TABLE `map_user_role` ADD FOREIGN KEY (user_id) REFERENCES mst_users(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `mst_buyer` ADD FOREIGN KEY (`company_id`) REFERENCES `mst_company` (`company_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `txn_production_shift` ADD FOREIGN KEY (`order_id`) REFERENCES `txn_order`(`order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE `txn_production_shift` ADD FOREIGN KEY (`company_id`) REFERENCES `mst_company`(`company_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE `txn_production_shift` ADD FOREIGN KEY (`machine_id`) REFERENCES `mst_machine`(`machine_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `mst_seller` MODIFY `seller_seq` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
ALTER TABLE `mst_seller` ADD FOREIGN KEY (`company_id`) REFERENCES `mst_company` (`company_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `txn_stock` MODIFY `stock_seq` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
ALTER TABLE `txn_stock` ADD FOREIGN KEY (`company_id`) REFERENCES `mst_company` (`company_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
