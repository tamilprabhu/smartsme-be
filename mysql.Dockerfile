...
COPY db/seed/dev/030-dev-seed.sql /docker-entrypoint-initdb.d/030-dev-seed.sql
COPY db/migrations/040-auto-increment-setup.sql /docker-entrypoint-initdb.d/040-auto-increment-setup.sql
